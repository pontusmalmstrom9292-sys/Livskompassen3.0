...
function Card({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div
      ...
      style={{ background: "#10131e", borderColor: "rgba(201,164,53,0.15)" }}
    >
      {children}
    </div>
  );
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        <div className="relative z-10 p-5 flex gap-4">
          <div className="flex-1">
            ...
            <p className="text-xs mb-4" style={{ color: "#b8b0a0" }}>
          ...
          >
            <p style={{ color: "#c9a435", fontSize: 10, letterSpacing: "0.1em" }}>
              Reflektionsfråga
            </p>
            <p style={{ color: "#d8d0c0", lineHeight: 1.5 }}>
              Du är lite trygga hamnen — även när våren känns splittrad.
            </p>
            <GoldDivider />
            <p style={{ color: "#c9a435", fontSize: 10, letterSpacing: "0.1em" }}>
              Vad vill din inre Kasper säga — en sak?
            </p>
            <p style={{ color: "#7a7a9a", lineHeight: 1.5, fontSize: 10 }}>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Card>
          ...
          <h3
            ...
            style={{ fontFamily: "Lora, serif", color: "#f0ead8" }}
          >
            Barnfokus
          </h3>
          <p className="text-xs mb-3" style={{ color: "#7a7a9a" }}>
        ...
        <Card>
          <div className="flex items-center gap-2 mb-3">
            <MessageSquare size={14} style={{ color: "#c9a435" }} />
      ...
      <Card>
        ...
        {editAnchor ? (
          ...
          <p
            ...
            style={{ color: "#d8d0c0", fontFamily: "Lora, serif" }}
      ...
      <Card>
        ...
        <div className="flex gap-1 mb-4 flex-wrap">
          ...
          <span className="ml-auto text-[10px]" style={{ color: "#7a7a9a" }}>
            Tisdag
          </span>
        </div>
        ...
        <p
          ...
          style={{ color: "#c9a435", fontFamily: "Cinzel, serif", letterSpacing: "0.1em" }}
        >
          Dagens uppgifter
        </p>
            ...
            <div key={task.id} className="flex items-center gap-3">
              <div
                ...
                style={{
                  ...
                  background: task.done ? "#c9a435" : "transparent",
                }}
              >
                {task.done && <Check size={10} color="#080a12" />}
              </div>
              <span
                className="text-xs"
                style={{
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-[10px]" style={{ color: "#c9a435" }}>
            Visa alla →
          </button>
        </div>
        <div className="flex flex-col gap-2">
          {notes.map((n, i) => (
            <Card key={i} className="flex items-center justify-between py-3 px-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs" style={{ color: "#d8d0c0" }}>
                  {n.title}
                </span>
              </div>
    ...
    <div className="flex flex-col gap-4">
      <Card>
        ...
        <div className="flex items-end gap-2 mb-1">
          ...
          <span className="text-sm mb-1" style={{ color: "#7a7a9a" }}>
            kr
          </span>
          <span
        ...
        <div className="h-40">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={economyData}>
              <defs>
                <linearGradient id="lkGoldGrad1" x1="0" y1="0" x2="0" y2="1">
        ...
        {expenses.map((e, i) => (
          <Card key={i} className="py-3">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-sm font-medium" style={{ color: "#c9a435" }}>
                {e.amount}
              </span>
            </div>
            <div
            ...
            >
              <div
                ...
                style={{
                  width: `${e.pct}%`,
                  background: "linear-gradient(90deg, #c9a435, #f0c060)",
                }}
              />
            </div>
          </Card>
...
function ResurserScreen() {
  const categories = [
    ...
    { icon: <Dumbbell size={16} />, label: "Rörelse", count: 7 },
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs mt-1" style={{ color: "#b8b0a0" }}>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {categories.map((c, i) => (
          ...
          >
            ...
            <span className="text-xs font-medium" style={{ color: "#d8d0c0" }}>
              {c.label}
            </span>
            <span
  ...
  const entries = [
    {
      ...
      preview: "Idag kände jag mig mer centrerad än på länge. Tog en lång promenad och...",
    },
    {
      date: "19 Jun 2026",
      title: "Reflektioner kring förändring",
      preview: "Det är märkligt hur snabbt livet kan förändras när man börjar ta ansvar...",
    },
    {
      date: "15 Jun 2026",
      title: "Tacksamhetslista",
      preview: "1. Min hälsa. 2. Min familj. 3. Möjligheten att växa som person...",
    },
  ];
          ...
          >
            <div className="flex items-start justify-between mb-1">
              <span
                ...
                style={{ color: "#f0ead8", fontFamily: "Lora, serif" }}
              >
                {e.title}
              </span>
              <span className="text-[10px] ml-3 flex-shrink-0" style={{ color: "#7a7a9a" }}>
                {e.date}
              </span>
            </div>
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card className="flex items-center gap-4">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #c9a435, #8a6a20)",
          }}
        >
        ...
        <div>
          <p
            ...
            style={{ color: "#f0ead8", fontFamily: "Cinzel, serif" }}
          >
            Kasper Livsson
          </p>
          ...
          <span
            ...
            style={{ background: "rgba(201,164,53,0.15)", color: "#c9a435" }}
          >
            Premium
          </span>
        </div>
        ...
        <div key={si}>
          ...
          <div className="flex flex-col">
            {s.items.map((item, ii) => (
              ...
              >
                {item}
                <ChevronRight size={14} style={{ color: "#7a7a9a" }} />
              </button>
            ))}
          </div>
        </div>
...
export default function App() {
  ...
  return (
    <div
      ...
      style={{ background: "#080a12", fontFamily: "Inter, sans-serif" }}
    >
      {/* Top nav */}
      <header
      ...
      >
        {/* Hamburger */}
        <button className="p-1.5 rounded-lg" style={{ color: "#c9a435" }}>
          <Menu size={20} />
        </button>
        ...
        <div className="flex flex-col items-center gap-1">
          <h1
            ...
            style={{ color: "#c9a435", fontFamily: "Cinzel, serif", fontWeight: 600 }}
          >
            Livskompassen
          </h1>
          {/* Decorative diamond-dot ornament */}
          <div className="flex items-center gap-1">
            <div className="w-6 h-px" style={{ background: "rgba(201,164,53,0.4)" }} />
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            style={{ background: "rgba(201,164,53,0.12)", color: "#c9a435" }}
          >
            <Settings size={14} />
          </button>
          <button
      ...
      <main className="flex-1 overflow-y-auto px-4 py-4 pb-24">
        <div className="max-w-2xl mx-auto">{screens[activeTab]}</div>
      </main>
      ...
      <nav
        ...
        style={{
          ...
          borderTop: "1px solid rgba(201,164,53,0.15)",
        }}
      >
        <div className="flex items-end justify-around px-2 pb-3 pt-1 max-w-2xl mx-auto">
          {/* ANTECKNINGAR */}
          <button
            onClick={() => setActiveTab("dagbok")}
            className="flex flex-col items-center gap-1 pt-2"
          >
            <NotebookPen size={18} style={{ color: activeTab === "dagbok" ? "#c9a435" : "#7a7a9a" }} />
            <span className="text-[8px] tracking-wider" style={{ fontFamily: "Cinzel, serif", color: activeTab === "dagbok" ? "#c9a435" : "#7a7a9a" }}>
              ANTECKNINGAR
            </span>
          </button>
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 pt-2"
          >
            <Users2 size={18} style={{ color: activeTab === "installningar" ? "#c9a435" : "#7a7a9a" }} />
            <span className="text-[8px] tracking-wider" style={{ fontFamily: "Cinzel, serif", color: activeTab === "installningar" ? "#c9a435" : "#7a7a9a" }}>
              FAMILJ
            </span>
          </button>

          {/* Center compass — elevated */}
          <button
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 28px rgba(201,164,53,0.55), 0 0 8px rgba(201,164,53,0.3), 0 8px 24px rgba(0,0,0,0.7)",
              }}
            >
              <svg width="64" height="64" viewBox="0 0 180 180" fill="none">
                <defs>
                  <radialGradient id="dockGoldGlow">
                    <stop offset="0%" stopColor="#F7D774" />
                    <stop offset="100%" stopColor="#A77A16" />
                  </radialGradient>
                  <radialGradient id="dockCenterGlow">
                ...
                <circle cx="90" cy="90" r="78" fill="url(#dockCenterGlow)" opacity="0.25" filter="url(#dockShadow)" />
                <circle cx="90" cy="90" r="72" stroke="url(#dockGoldGlow)" strokeWidth="3" />
                <circle cx="90" cy="90" r="58" stroke="rgba(247,215,116,0.45)" strokeWidth="1.5" />
                <polygon points="90,22 102,78 158,90 102,102 90,158 78,102 22,90 78,78" fill="url(#dockGoldGlow)" />
                <polygon points="90,40 98,82 140,90 98,98 90,140 82,98 40,90 82,82" fill="#06101B" />
                <circle cx="90" cy="90" r="10" fill="url(#dockGoldGlow)" />
              </svg>
            </div>
            <span className="text-[8px] tracking-wider mt-1" style={{ fontFamily: "Cinzel, serif", color: activeTab === "hem" ? "#c9a435" : "#7a7a9a" }}>
              KOMPASSEN
            </span>
          </button>
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 pt-2"
          >
            <UtensilsCrossed size={18} style={{ color: activeTab === "ekonomi" ? "#c9a435" : "#7a7a9a" }} />
            <span className="text-[8px] tracking-wider" style={{ fontFamily: "Cinzel, serif", color: activeTab === "ekonomi" ? "#c9a435" : "#7a7a9a" }}>
              RECEPT
            </span>
          </button>
          ...
          {/* RESURSER */}
          <button
            onClick={() => setActiveTab("resurser")}
            className="flex flex-col items-center gap-1 pt-2"
          >
            <Library size={18} style={{ color: activeTab === "resurser" ? "#c9a435" : "#7a7a9a" }} />
            <span className="text-[8px] tracking-wider" style={{ fontFamily: "Cinzel, serif", color: activeTab === "resurser" ? "#c9a435" : "#7a7a9a" }}>
              RESURSER
            </span>
          </button>
        </div>
