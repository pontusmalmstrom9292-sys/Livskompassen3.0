...
exports.DEFAULT_SCOPE_PERCENT = exports.DEFAULT_BREAK_MINUTES = exports.DEFAULT_HELDAG = exports.TIMEZONE = void 0;
exports.formatDateLocal = formatDateLocal;
exports.formatTimeLocal = formatTimeLocal;
exports.normalizeClock = normalizeClock;
exports.parseDateOnly = parseDateOnly;
exports.parseClockOnDate = parseClockOnDate;
exports.buildCategoryName = buildCategoryName;
exports.categoryBase = categoryBase;
exports.computeHoursWorked = computeHoursWorked;
exports.getMonday = getMonday;
exports.getWeekNumber = getWeekNumber;
exports.eachDateInclusive = eachDateInclusive;
exports.emptyWeekCalendar = emptyWeekCalendar;
exports.TIMEZONE = 'Europe/Stockholm';
exports.DEFAULT_HELDAG = { in: '08:00', out: '16:30' };
exports.DEFAULT_BREAK_MINUTES = 30;
exports.DEFAULT_SCOPE_PERCENT = 100;
...
function buildCategoryName(category, scopePercent) {
    const cat = category.trim();
    if (!cat)
        throw new Error('Kategori saknas.');
...
function computeHoursWorked(params) {
    if (!params.clockOut)
        return 0;
...
function eachDateInclusive(from, to) {
    ...
    if (end < start)
        throw new Error('"Till"-datum kan inte vara före "Från"-datum.');
    const out = [];
...
function emptyWeekCalendar(date = new Date()) {
