    ...
    <svg viewBox="0 0 100 100" width={size} height={size} className={['cw-lotus', className].filter(Boolean).join(' ')} style={style} aria-hidden focusable="false">
      <defs>
        <linearGradient id={lotusBlue} x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor={WidgetPalette.etherealBlue} /><stop offset="50%" stopColor="#2563eb" /><stop offset="100%" stopColor="#1e3a8a" />
        </linearGradient>
      ...
      <path d="M50 20 C60 38, 62 55, 50 78 C38 55, 40 38, 50 20 Z" fill={`url(#${lotusBlue})`} stroke="#93c5fd" strokeWidth="1" />
