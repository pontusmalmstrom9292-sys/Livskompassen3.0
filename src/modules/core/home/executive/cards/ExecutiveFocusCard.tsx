      ...
      <div className="mt-3 flex flex-wrap gap-1.5">
        {FOCUS_PILLS.map((pill) => (
          <Button
            key={pill.id}
            type="button"
            variant={pill.active ? 'accent' : 'ghost'}
            size="sm"
            aria-selected={pill.active}
            className="exec-home-pill min-h-11 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent/55"
