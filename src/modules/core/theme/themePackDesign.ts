...
export const THEME_PACK_DESIGN: ThemePack[] = [
  ...
  {
    id: 'D4-flat-deluxe',
    label: 'D4 — Flat deluxe',
    description: 'Tunn guld meny, luftig header, subtil scenic — ren flat chrome (prod).',
    background: 'mockup-scenic',
    ...
    cssVars: {
      ...
      '--surface-2': '#161c22',
      '--surface-3': '#1c242c',
      '--glass': 'rgba(8, 12, 16, 0.52)',
      '--glass-hero': 'rgba(8, 12, 16, 0.68)',
      '--accent-glow': 'rgba(212, 175, 55, 0.24)',
