...
function ActionTile({
  ...
  return (
    <Link
      to={to}
      className="fyren-widget-bar__action min-h-11 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
      aria-label={label}
      tabIndex={tabIndex}
      onClick={onNavigate}
    >
  ...
  return (
    <>
      {open ? (
        <button
          type="button"
          className="fyren-widget-bar__backdrop focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
...
export function FyrenDockHandle({
  ...
  return (
    <button
      type="button"
      className={clsx(
        'fyren-dock-handle min-h-11 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40',
