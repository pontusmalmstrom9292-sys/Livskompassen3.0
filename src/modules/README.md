...
| **Liv och göra (superhub)** | `/liv` | `@/features/dailyLife` + `@/shell/LivShellPage` |
| **Vardagen (legacy)** | `/vardagen` → redirect `/liv` | `@/features/dailyLife/wellbeing/compasses` |
| **Arbetsliv** | `/arbetsliv` | `@/features/dailyLife/arbetsliv` |
| **Familjen** | `/familj` | `@/features/family` |
