export { KompisAvatar } from './components/KompisAvatar';
...
export type { KompisState, Kampspar, SubSynapticData, KompisContextType } from './types/kompis';
export { initialSubSynapticData } from './types/kompis';
