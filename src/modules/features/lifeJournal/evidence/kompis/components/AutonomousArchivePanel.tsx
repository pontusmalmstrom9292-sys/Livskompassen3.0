                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {node.isAutoGenerated && (
                      <span title="Mapp auto-skapad av AI" aria-hidden>
                        <Sparkles className="ml-1 h-3 w-3 text-accent opacity-60" />
                      </span>
                    )}
                  </div>
                  <div className="flex items-center gap-2">
  ...
  return (
    <div className="calm-card overflow-hidden p-1">
      ...
      <div className="flex items-start justify-between rounded-t-xl border-b border-border/30 bg-surface-2 p-4 sm:p-5">
        ...
        <div className="flex items-center gap-1.5 rounded-md border border-accent/20 bg-accent/10 px-2 py-1">
