  ...
  return (
    <div className="mt-4 space-y-3">
      <div className="rounded-xl border border-accent/20 bg-accent/5 px-4 py-3">
        ...
        <p className="mt-1 text-xs text-text-dim">Uppskattning — inga mål, inga kalorier.</p>

        <dl className="mt-3 grid grid-cols-3 gap-2 text-center">
          <div className="rounded-lg border border-border bg-surface/50 px-2 py-2">
            <dt className="text-[10px] uppercase tracking-wider text-text-dim">Protein</dt>
            <dd className="font-display-serif text-xl tabular-nums text-text">{totals.proteinG}</dd>
          </div>
          <div className="rounded-lg border border-border bg-surface/50 px-2 py-2">
            <dt className="text-[10px] uppercase tracking-wider text-text-dim">Fett</dt>
            <dd className="font-display-serif text-xl tabular-nums text-text">{totals.fatG}</dd>
          </div>
          <div className="rounded-lg border border-border bg-surface/50 px-2 py-2">
            <dt className="text-[10px] uppercase tracking-wider text-text-dim">Kolhydrat</dt>
      ...
      <div className="rounded-xl border border-border bg-surface-2/60 px-4 py-3">
        <p className="text-xs font-medium uppercase tracking-wider text-text-dim">Portionsguide</p>
