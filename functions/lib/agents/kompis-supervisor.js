...
exports.KompisSupervisor = void 0;
const cards_1 = require("./cards");
const DCAP_1 = require("./DCAP");
const vertexCache_1 = require("../lib/vertexCache");
 ...
 */
class KompisSupervisor {
    constructor() {
        this.supervisorId = 'agent_kompis_supervisor';
    }
    /**
     ...
     */
    async handleUserRequest(userInput, userId, ragContext = []) {
        ...
        const [dcapResult, cachedCtx] = await Promise.all([
            (0, DCAP_1.analyzeDcap)(userInput, PROJECT_ID),
            (0, vertexCache_1.getOrCreateCache)(`kompis_${userId}`, {
        ...
        else if (dcapResult.recommendedAction === 'COACHING' ||
        ...
        const targetCard = cards_1.AvailableAgents[targetAgentId];
        if (!targetCard) {
            return {
        ...
        const aiResponse = await (0, vertexCache_1.generateWithCache)(cachedCtx, agentPrompt);
    ...
    invalidateUserSession(userId) {
        (0, vertexCache_1.invalidateCache)(`kompis_${userId}`);
        console.log(`[Kompis] Session rensad för uid=${userId}`);
    }
}
exports.KompisSupervisor = KompisSupervisor;
//# sourceMappingURL=kompis-supervisor.js.map