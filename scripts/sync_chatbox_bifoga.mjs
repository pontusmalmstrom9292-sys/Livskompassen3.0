...
const GROUPS = {
  ...
  '03-prompter': [
    'docs/external-ai/chatbox/CHATBOT-MASTER-PROMPT.md',
    'docs/external-ai/chatbox/phases/PHASE-07-final-lock.md',
    'docs/external-ai/chatbox/MODEL-PICKER.md',
    ...
    'docs/external-ai/gemini/GEMINI-ORKESTER-MASTER-PROMPT.md',
    'docs/external-ai/gemini/GEMINI-FLOW-CHAT-PROMPTS.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-LATHUND.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-MASTER.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SYSTEM-AUDIT-MASTER.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA1.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA2.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA3.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA4.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA5.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA6.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA7.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA8.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA9.md',
    'docs/external-ai/bifoga/03-prompter/GEMINI-DEEP-RESEARCH-SA10.md',
    'docs/external-ai/bifoga/03-prompter/CURSOR-FLOW-CREDITS-SYNTHESIS.md',
  ],
};
