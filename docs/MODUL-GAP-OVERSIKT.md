...
| **liv** | `/vardagen` launcher | **LivLauncher Fas 2 done** 2026-06-06 — kortgrid + LivBackLink · fullsid `/mabra` `/planering` `/arbetsliv` | [`2026-06-06-liv-super-cursor-plan.md`](./evaluations/2026-06-06-liv-super-cursor-plan.md) |
