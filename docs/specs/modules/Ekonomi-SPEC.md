...
**Senast synkad mot kod:** 2026-05-23 (Fas 4B).
...
- **Route:** `/ekonomi` → redirect `/vardagen?tab=ekonomi` (AuthGate på `/vardagen`)
- **Dock:** Map → Vardagen-hub; flik `ekonomi` i `VardagenPage`
- **Ingång:** FloatingDock + Vardagen-flik ekonomi
...
**Fas 2 (ej MVP):** `functions/src/economy/vendor/` — lönespec/tid/skatt; **ingen** UI-koppling än.
