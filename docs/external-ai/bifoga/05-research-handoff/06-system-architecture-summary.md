...
**Senast synkad:** 2026-07-17 · Källfiler i `docs/system_sync/*_CURRENT.*` · styrning: `system_plan_CURRENT.md`, `locked_ux_features_CURRENT.md` · säkerhet: `firestore_rules_CURRENT.rules`, `storage_rules_CURRENT.rules`
