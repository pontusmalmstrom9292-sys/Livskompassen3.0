...
All infrastruktur är på plats (2026-06-15).

- Skript: `scripts/pack_chatbot_security.mjs`, `scripts/snapshot_locked_module.sh`
- npm: `chatbot:pack:security`, `chatbot:pack:all`
