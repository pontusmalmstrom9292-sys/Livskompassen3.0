...
**Kört:** 2026-06-06T02:05:14.935Z
**Git:** main @ 43d3bee6 (13 unstaged)

## Faser

| Fas | Status | ms |
|-----|--------|-----|
| Cursor-native smoke:rollout | PASS | 19427 |
| Functions build | PASS | 13309 |
| Frontend build | PASS | 10289 |
| ESLint | SKIP_FAIL | 12647 |
