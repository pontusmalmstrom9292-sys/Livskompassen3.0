...
> **Previous chapter:** [29-Dark-Mode.md](./29-Dark-Mode.md)  
> **Next chapter:** [31-Code-Standards.md](./31-Code-Standards.md)
...
**Focus:** memoization, lazy routes, backdrop-blur budget, Lighthouse ≥85, G85 targets, scale-to-zero
