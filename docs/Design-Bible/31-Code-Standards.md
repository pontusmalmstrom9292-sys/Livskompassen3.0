# Chapter 31 — Code Standards

> **Design Bible · Livskompassen 3.0**  
> **Theme:** Executive Midnight (DAD v1.0)  
> **Previous chapter:** [30-Performance.md](./30-Performance.md)  
> **Next chapter:** [32-AI-Rules.md](./32-AI-Rules.md)
...
## Detail — Code Standards

**Focus:** tokens only, no hex in features/, Chameleon Logic/Shell/Skin, component-standards, DS primitives
...
*End of Chapter 31 — Code Standards*
