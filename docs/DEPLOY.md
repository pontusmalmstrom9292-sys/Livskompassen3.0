...
firebase deploy --only functions:analyzeMessage,functions:invalidateSession,functions:generateEmbedding,functions:knowledgeVaultQuery,functions:valvChatQuery,functions:scheduledRetentionJob,functions:weaveJournalEntry,functions:speglingsMirror --force
```
