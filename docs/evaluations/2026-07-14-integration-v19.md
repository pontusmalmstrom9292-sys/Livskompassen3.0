...
**GO** — obligatoriska smokes gröna, seed dry-run grön. Preflight-sync har känd saknad källa (ej blockerande för innehållsintegration). Startgate → P152 yolo-vakt slutgate.
