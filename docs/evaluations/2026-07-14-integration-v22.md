...
**GO** — obligatoriska smokes gröna, seed dry-run grön. Preflight-sync har känd saknad källa (ej blockerande för innehållsintegration). Startgate → P182 yolo-vakt slutgate.
