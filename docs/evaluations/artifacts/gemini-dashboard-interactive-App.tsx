/**
 * Gemini Livskompassen 3.0 — interactive dashboard mock (inkorg only).
 * NOT part of Vite build. Extracted from user paste in Cursor chat 2026-05-22.
 * Map to FUNKTIONSLOCK F-01–F-09; integrate into existing modules, not src/App.
 */
